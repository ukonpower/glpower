...
exports.default = gulp.series( esLint, setDevLibraryPath, cleanDevFiles, develop );
exports.docs = gulp.series( esLint, setDevDocumentsPath, develop );
exports.build = gulp.series( esLint, cleanBuildFiles, buildPackages, buildExamples, setDevDocumentsPath, develop );
