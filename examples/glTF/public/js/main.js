...
/******/ 	return __webpack_require__(__webpack_require__.s = "./examples/glTF/src/ts/main.ts");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./examples/glTF/src/ts/main.ts":
/*!**************************************!*\
  !*** ./examples/glTF/src/ts/main.ts ***!
  \**************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"APP\", function() { return APP; });\n/* harmony import */ var _src__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../src */ \"./src/index.ts\");\n/* harmony import */ var _shaders_model_vs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./shaders/model.vs */ \"./examples/glTF/src/ts/shaders/model.vs\");\n/* harmony import */ var _shaders_model_vs__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_shaders_model_vs__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _shaders_model_fs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./shaders/model.fs */ \"./examples/glTF/src/ts/shaders/model.fs\");\n/* harmony import */ var _shaders_model_fs__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_shaders_model_fs__WEBPACK_IMPORTED_MODULE_2__);\n\n\n\nvar APP = /** @class */ (function () {\n    function APP() {\n        this.time = 0;\n        this.renderer = new _src__WEBPACK_IMPORTED_MODULE_0__[\"Renderer\"]({\n            canvas: document.querySelector('#canvas'),\n            retina: true\n        });\n        this.gl = this.renderer.gl;\n        this.renderer.setSize(window.innerWidth, window.innerHeight);\n        this.initScene();\n        this.animate();\n        window.addEventListener('resize', this.resize.bind(this));\n    }\n    APP.prototype.initScene = function () {\n        var _this = this;\n        this.scene = new _src__WEBPACK_IMPORTED_MODULE_0__[\"Scene\"]();\n        this.camera = new _src__WEBPACK_IMPORTED_MODULE_0__[\"Camera\"](50, 0.1, 1000, window.innerWidth / window.innerHeight);\n        this.camera.position.set(0, 0, 5);\n        var mat = new _src__WEBPACK_IMPORTED_MODULE_0__[\"Material\"]({\n            frag: _shaders_model_fs__WEBPACK_IMPORTED_MODULE_2___default.a,\n            vert: _shaders_model_vs__WEBPACK_IMPORTED_MODULE_1___default.a,\n            uniforms: {},\n        });\n        var loader = new _src__WEBPACK_IMPORTED_MODULE_0__[\"GLTFLoader\"]();\n        loader.load('./assets/suzanne.gltf', function (data) {\n            console.log(data);\n            var geo = new _src__WEBPACK_IMPORTED_MODULE_0__[\"Geometry\"]();\n            geo.add('position', data.Suzanne.position.array, data.Suzanne.position.size);\n            geo.add('normal', data.Suzanne.normal.array, data.Suzanne.normal.size);\n            geo.add('uv', data.Suzanne.texcoord_0.array, data.Suzanne.texcoord_0.size);\n            geo.add('index', data.Suzanne.indices.array, data.Suzanne.indices.size);\n            _this.model = new _src__WEBPACK_IMPORTED_MODULE_0__[\"PowerObj\"]({\n                geo: geo,\n                mat: mat\n            });\n            _this.scene.add(_this.model);\n        });\n    };\n    APP.prototype.animate = function () {\n        this.time += 1.0;\n        if (this.model) {\n            // this.model.rotation.x = this.time * 0.02;\n            this.model.rotation.y = this.time * 0.02;\n        }\n        this.renderer.render(this.scene, this.camera);\n        requestAnimationFrame(this.animate.bind(this));\n    };\n    APP.prototype.resize = function () {\n        this.camera.aspect = window.innerWidth / window.innerHeight;\n        this.renderer.setSize(window.innerWidth, window.innerHeight);\n    };\n    return APP;\n}());\n\nwindow.addEventListener('load', function () {\n    var app = new APP();\n});\n\n\n//# sourceURL=webpack:///./examples/glTF/src/ts/main.ts?");

/***/ }),

/***/ "./examples/glTF/src/ts/shaders/model.fs":
/*!***********************************************!*\
  !*** ./examples/glTF/src/ts/shaders/model.fs ***!
  \***********************************************/
...
eval("module.exports = \"precision highp float;\\r\\n\\r\\nvarying vec3 vColor;\\r\\nvarying vec3 normal;\\r\\n\\r\\nvoid main( void ){\\r\\n\\t\\r\\n\\tgl_FragColor = vec4( vColor, 1.0 );\\r\\n\\t\\r\\n}\"\n\n//# sourceURL=webpack:///./examples/glTF/src/ts/shaders/model.fs?");

/***/ }),

/***/ "./examples/glTF/src/ts/shaders/model.vs":
/*!***********************************************!*\
  !*** ./examples/glTF/src/ts/shaders/model.vs ***!
  \***********************************************/
/*! no static exports found */
...
eval("module.exports = \"precision highp float;\\r\\n\\r\\nattribute vec3 position;\\r\\nattribute vec3 color;\\r\\nattribute vec3 normal;\\r\\nattribute vec2 uv;\\r\\n\\r\\nuniform float time;\\r\\nuniform mat4 modelViewMatrix;\\r\\nuniform mat4 projectionMatrix;\\r\\n\\r\\nvarying vec3 vColor;\\r\\n\\r\\nvoid main( void ){\\r\\n\\t\\r\\n\\tvec4 mvPosition = modelViewMatrix * vec4( position, 1.0 );\\r\\n    gl_Position = projectionMatrix * mvPosition;\\r\\n\\tgl_PointSize = 5.0;\\r\\n\\r\\n\\tvColor = normal;\\r\\n\\t// vColor = normal + 0.5;\\r\\n\\r\\n}\"\n\n//# sourceURL=webpack:///./examples/glTF/src/ts/shaders/model.vs?");
...
/*!**********************!*\
  !*** ./src/index.ts ***!
  \**********************/
/*! exports provided: Renderer, FrameBuffer, Material, Camera, Geometry, CubeGeometry, CylinderGeometry, PlaneGeometry, SphereGeometry, Scene, Empty, PowerObj, Vec2, Vec3, Mat4, Texture, GLTFLoader */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
