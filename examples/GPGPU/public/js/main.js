...
/******/ 	return __webpack_require__(__webpack_require__.s = "./examples/GPGPU/src/ts/main.ts");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./examples/GPGPU/src/ts/GPUComputationController/index.ts":
/*!*****************************************************************!*\
  !*** ./examples/GPGPU/src/ts/GPUComputationController/index.ts ***!
  \*****************************************************************/
...
eval("module.exports = \"precision highp float;\\n\\nattribute vec3 position;\\nattribute vec2 uv;\\n\\nuniform mat4 modelViewMatrix;\\nuniform mat4 projectionMatrix;\\n\\n\\nvarying vec2 vUv;\\n\\nvoid main() {\\n    gl_Position = vec4( position, 1.0 );\\n    vUv = uv;\\n}\"\n\n//# sourceURL=webpack:///./examples/GPGPU/src/ts/GPUComputationController/shaders/passThrough.vs?");

/***/ }),

/***/ "./examples/GPGPU/src/ts/main.ts":
/*!***************************************!*\
  !*** ./examples/GPGPU/src/ts/main.ts ***!
  \***************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"APP\", function() { return APP; });\n/* harmony import */ var _src__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../src */ \"./src/index.ts\");\n/* harmony import */ var _shaders_cube_vs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./shaders/cube.vs */ \"./examples/GPGPU/src/ts/shaders/cube.vs\");\n/* harmony import */ var _shaders_cube_vs__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_shaders_cube_vs__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _shaders_cube_fs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./shaders/cube.fs */ \"./examples/GPGPU/src/ts/shaders/cube.fs\");\n/* harmony import */ var _shaders_cube_fs__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_shaders_cube_fs__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var _shaders_tex_fs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./shaders/tex.fs */ \"./examples/GPGPU/src/ts/shaders/tex.fs\");\n/* harmony import */ var _shaders_tex_fs__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_shaders_tex_fs__WEBPACK_IMPORTED_MODULE_3__);\n/* harmony import */ var _shaders_standard_vs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./shaders/standard.vs */ \"./examples/GPGPU/src/ts/shaders/standard.vs\");\n/* harmony import */ var _shaders_standard_vs__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_shaders_standard_vs__WEBPACK_IMPORTED_MODULE_4__);\n/* harmony import */ var _shaders_computePosition_fs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./shaders/computePosition.fs */ \"./examples/GPGPU/src/ts/shaders/computePosition.fs\");\n/* harmony import */ var _shaders_computePosition_fs__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_shaders_computePosition_fs__WEBPACK_IMPORTED_MODULE_5__);\n/* harmony import */ var _shaders_computeVelocity_fs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./shaders/computeVelocity.fs */ \"./examples/GPGPU/src/ts/shaders/computeVelocity.fs\");\n/* harmony import */ var _shaders_computeVelocity_fs__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_shaders_computeVelocity_fs__WEBPACK_IMPORTED_MODULE_6__);\n/* harmony import */ var _GPUComputationController__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./GPUComputationController */ \"./examples/GPGPU/src/ts/GPUComputationController/index.ts\");\n\n\n\n\n\n\n\n\nvar APP = /** @class */ (function () {\n    function APP() {\n        this.time = 0;\n        this.renderer = new _src__WEBPACK_IMPORTED_MODULE_0__[\"Renderer\"]({\n            canvas: document.querySelector('#canvas'),\n            retina: true\n        });\n        this.gl = this.renderer.gl;\n        this.renderer.setSize(window.innerWidth, window.innerHeight);\n        this.initScene();\n        this.initComputing();\n        this.animate();\n        window.addEventListener('resize', this.resize.bind(this));\n    }\n    APP.prototype.initComputing = function () {\n        this.gcon = new _GPUComputationController__WEBPACK_IMPORTED_MODULE_7__[\"GPUComputationController\"](this.gl, this.renderer, new _src__WEBPACK_IMPORTED_MODULE_0__[\"Vec2\"](100, 100));\n        this.gdataPos = this.gcon.createData();\n        this.gdataVel = this.gcon.createData();\n        this.gKernelVel = this.gcon.createKernel(_shaders_computeVelocity_fs__WEBPACK_IMPORTED_MODULE_6___default.a);\n        this.gKernelPos = this.gcon.createKernel(_shaders_computePosition_fs__WEBPACK_IMPORTED_MODULE_5___default.a);\n        this.gKernelVel.uniforms.texVel = { value: null };\n        this.gKernelVel.uniforms.texPos = { value: null };\n        this.gKernelPos.uniforms.texVel = { value: null };\n        this.gKernelPos.uniforms.texPos = { value: null };\n    };\n    APP.prototype.initScene = function () {\n        this.scene = new _src__WEBPACK_IMPORTED_MODULE_0__[\"Scene\"]();\n        this.camera = new _src__WEBPACK_IMPORTED_MODULE_0__[\"Camera\"](50, 0.1, 1000, window.innerWidth / window.innerHeight);\n        this.camera.position.set(0, 0, 5);\n        var geo = new _src__WEBPACK_IMPORTED_MODULE_0__[\"CubeGeometry\"](0.1, 0.1, 0.1);\n        var offsetPosArray = [];\n        var nArray = [];\n        for (var i = 0; i < 1000; i++) {\n            offsetPosArray.push((Math.random() - 0.5) * 3, (Math.random() - 0.5) * 3, (Math.random() - 0.5) * 3);\n            nArray.push(i);\n        }\n        geo.add('offsetPos', offsetPosArray, 3, true);\n        geo.add('n', nArray, 1, true);\n        this.uniforms = {\n            time: {\n                value: 0\n            }\n        };\n        var mat = new _src__WEBPACK_IMPORTED_MODULE_0__[\"Material\"]({\n            frag: _shaders_cube_fs__WEBPACK_IMPORTED_MODULE_2___default.a,\n            vert: _shaders_cube_vs__WEBPACK_IMPORTED_MODULE_1___default.a,\n            uniforms: this.uniforms,\n            culling: this.gl.CCW,\n        });\n        this.cube = new _src__WEBPACK_IMPORTED_MODULE_0__[\"RenderingObject\"]({\n            geo: geo,\n            mat: mat\n        });\n        // this.scene.add( this.cube );\n        this.screenUni = {\n            texture: {\n                value: null\n            }\n        };\n        var screen = new _src__WEBPACK_IMPORTED_MODULE_0__[\"RenderingObject\"]({\n            mat: new _src__WEBPACK_IMPORTED_MODULE_0__[\"Material\"]({\n                frag: _shaders_tex_fs__WEBPACK_IMPORTED_MODULE_3___default.a,\n                vert: _shaders_standard_vs__WEBPACK_IMPORTED_MODULE_4___default.a,\n                uniforms: this.screenUni\n            }),\n            geo: new _src__WEBPACK_IMPORTED_MODULE_0__[\"PlaneGeometry\"](2.0, 2.0)\n        });\n        this.scene.add(screen);\n    };\n    APP.prototype.animate = function () {\n        this.time += 1.0;\n        this.uniforms.time.value = this.time;\n        //gpgpu\n        this.gKernelVel.uniforms.texVel.value = this.gdataVel.buffer.tex;\n        this.gKernelVel.uniforms.texPos.value = this.gdataPos.buffer.tex;\n        this.gcon.compute(this.gKernelVel, this.gdataVel);\n        this.gKernelPos.uniforms.texVel.value = this.gdataVel.buffer.tex;\n        this.gKernelPos.uniforms.texPos.value = this.gdataPos.buffer.tex;\n        this.gcon.compute(this.gKernelPos, this.gdataPos);\n        console.log(this.gdataPos.buffer);\n        this.screenUni.texture.value = this.gdataPos.buffer.tex;\n        var theta = this.time * 0.01;\n        var r = 5;\n        this.camera.position.x = Math.sin(theta) * r;\n        this.camera.position.z = Math.cos(theta) * r;\n        this.camera.rotation.y = theta;\n        this.renderer.render(this.scene, this.camera);\n        requestAnimationFrame(this.animate.bind(this));\n    };\n    APP.prototype.resize = function () {\n        this.camera.aspect = window.innerWidth / window.innerHeight;\n        this.renderer.setSize(window.innerWidth, window.innerHeight);\n    };\n    return APP;\n}());\n\nwindow.addEventListener('load', function () {\n    var app = new APP();\n});\n\n\n//# sourceURL=webpack:///./examples/GPGPU/src/ts/main.ts?");

/***/ }),

/***/ "./examples/GPGPU/src/ts/shaders/computePosition.fs":
/*!**********************************************************!*\
  !*** ./examples/GPGPU/src/ts/shaders/computePosition.fs ***!
  \**********************************************************/
/*! no static exports found */
...
eval("module.exports = \"precision highp float;\\r\\n\\r\\nuniform sampler2D texPos;\\r\\nuniform sampler2D texVel;\\r\\n\\r\\nvarying vec2 vUv;\\r\\n\\r\\nvoid main( void ){\\r\\n\\r\\n\\tgl_FragColor = texture2D( texPos, vUv ) + 0.5;\\r\\n\\t\\r\\n}\"\n\n//# sourceURL=webpack:///./examples/GPGPU/src/ts/shaders/computePosition.fs?");

/***/ }),

/***/ "./examples/GPGPU/src/ts/shaders/computeVelocity.fs":
/*!**********************************************************!*\
  !*** ./examples/GPGPU/src/ts/shaders/computeVelocity.fs ***!
  \**********************************************************/
/*! no static exports found */
...
eval("module.exports = \"precision highp float;\\r\\n\\r\\nuniform sampler2D texPos;\\r\\nuniform sampler2D texVel;\\r\\n\\r\\nvarying vec2 vUv;\\r\\n\\r\\n\\r\\nuniform vec2 resolution;\\r\\n\\r\\nvoid main( void ){\\r\\n\\r\\n\\tgl_FragColor = texture2D( texPos, vUv ) + 0.01;\\r\\n\\t\\r\\n}\"\n\n//# sourceURL=webpack:///./examples/GPGPU/src/ts/shaders/computeVelocity.fs?");

/***/ }),

/***/ "./examples/GPGPU/src/ts/shaders/cube.fs":
/*!***********************************************!*\
  !*** ./examples/GPGPU/src/ts/shaders/cube.fs ***!
  \***********************************************/
/*! no static exports found */
...
eval("module.exports = \"precision highp float;\\r\\n\\r\\nvarying vec3 vColor;\\r\\n\\r\\nvoid main( void ){\\r\\n\\t\\r\\n\\tgl_FragColor = vec4( vColor, 1.0 );\\r\\n\\t\\r\\n}\"\n\n//# sourceURL=webpack:///./examples/GPGPU/src/ts/shaders/cube.fs?");

/***/ }),

/***/ "./examples/GPGPU/src/ts/shaders/cube.vs":
/*!***********************************************!*\
  !*** ./examples/GPGPU/src/ts/shaders/cube.vs ***!
  \***********************************************/
/*! no static exports found */
...
eval("module.exports = \"precision highp float;\\r\\n\\r\\nattribute vec3 position;\\r\\nattribute vec3 normal;\\r\\nattribute vec2 uv;\\r\\n\\r\\nuniform float time;\\r\\nuniform mat4 modelViewMatrix;\\r\\nuniform mat4 projectionMatrix;\\r\\n\\r\\nvarying vec2 vUv;\\r\\n\\r\\nvoid main( void ){\\r\\n\\r\\n\\tvec4 mvPosition = modelViewMatrix * vec4( position, 1.0 );\\r\\n    gl_Position = projectionMatrix * mvPosition;\\r\\n\\r\\n\\tvUv = uv;\\r\\n\\r\\n}\"\n\n//# sourceURL=webpack:///./examples/GPGPU/src/ts/shaders/standard.vs?");

/***/ }),

/***/ "./examples/GPGPU/src/ts/shaders/tex.fs":
/*!**********************************************!*\
  !*** ./examples/GPGPU/src/ts/shaders/tex.fs ***!
  \**********************************************/
/*! no static exports found */
...
/*!**********************!*\
  !*** ./src/index.ts ***!
  \**********************/
<<<<<<< HEAD:examples/GPGPU/public/js/main.js
/*! exports provided: Renderer, FrameBuffer, Material, Camera, Geometry, CubeGeometry, CylinderGeometry, PlaneGeometry, SphereGeometry, Scene, Empty, RenderingObject, Vec2, Vec3, Mat4, Texture */
=======
...
>>>>>>> master:docs/examples/Instancing/js/main.js
/***/ (function(module, __webpack_exports__, __webpack_require__) {
