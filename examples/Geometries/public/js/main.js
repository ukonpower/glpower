...
/******/ 	return __webpack_require__(__webpack_require__.s = "./examples/Geometries/src/ts/main.ts");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./examples/Geometries/src/ts/main.ts":
/*!********************************************!*\
  !*** ./examples/Geometries/src/ts/main.ts ***!
  \********************************************/
...
eval("module.exports = \"precision highp float;\\r\\n\\r\\nvarying vec3 vColor;\\r\\n\\r\\nvoid main( void ){\\r\\n\\t\\r\\n\\tgl_FragColor = vec4( vColor, 1.0 );\\r\\n\\t\\r\\n}\"\n\n//# sourceURL=webpack:///./examples/Geometries/src/ts/shaders/cube.fs?");

/***/ }),

/***/ "./examples/Geometries/src/ts/shaders/cube.vs":
/*!****************************************************!*\
  !*** ./examples/Geometries/src/ts/shaders/cube.vs ***!
  \****************************************************/
/*! no static exports found */
...
/***/ "./src/objects/PowerObj.ts":
/*!****************************************!*\
  !*** ./src/objects/PowerObj.ts ***!
  \****************************************/
/*! exports provided: PowerObj */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"PowerObj\", function() { return PowerObj; });\n/* harmony import */ var _Empty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Empty */ \"./src/objects/Empty.ts\");\nvar __extends = (undefined && undefined.__extends) || (function () {\n    var extendStatics = function (d, b) {\n        extendStatics = Object.setPrototypeOf ||\n            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||\n            function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };\n        return extendStatics(d, b);\n    };\n    return function (d, b) {\n        extendStatics(d, b);\n        function __() { this.constructor = d; }\n        d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());\n    };\n})();\n\nvar PowerObj = /** @class */ (function (_super) {\n    __extends(PowerObj, _super);\n    function PowerObj(param) {\n        var _this = _super.call(this) || this;\n        _this.geometry = param.geo;\n        _this.material = param.mat;\n        _this.drawType = param.drawType;\n        _this.programNum = _this.material.programs.length;\n        _this.material.programs.push(null);\n        _this.IndividualUniforms = {\n            modelViewMatrix: {\n                value: _this.modelViewMatrix\n            },\n            projectionMatrix: {\n                value: null\n            }\n        };\n        return _this;\n    }\n    Object.defineProperty(PowerObj.prototype, \"isPowerObj\", {\n        get: function () {\n            return true;\n        },\n        enumerable: true,\n        configurable: true\n    });\n    return PowerObj;\n}(_Empty__WEBPACK_IMPORTED_MODULE_0__[\"Empty\"]));\n\n\n\n//# sourceURL=webpack:///./src/objects/PowerObj.ts?");
